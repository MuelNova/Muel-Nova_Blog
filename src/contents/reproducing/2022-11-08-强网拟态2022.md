...
![sym_read](https://cdn.ova.moe/img/image-20221108112206978.png)

![str_read](https://cdn.ova.moe/img/image-20221108112740265.png)



同时，我们可以在栈上找到一些可以用的数据来泄露程序基址和 `libc`

![](https://cdn.ova.moe/img/image-20221108113456187.png)
